    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                {!! Form::open(array('route' => ['perijinan.store'],'method'=>'POST','role' =>
                'form','autocomplete'=>'off', 'id' => 'my_form','enctype'=>"multipart/form-data")) !!}
                <div class="form-group row">
                    <label for="nama" class="col-2 col-form-label">Nama</label>
                    <div class="col-10">
                        <input class="form-control" type="nomor" value="" name="nama" />
                    </div>
                </div>
                <div class="form-group row">
                    <label for="kepanjangan" class="col-2 col-form-label">Kepanjangan</label>
                    <div class="col-10">
                        <input class="form-control" type="text" value="" name="kepanjangan">
                    </div>
                </div>
                <div class="form-group row">

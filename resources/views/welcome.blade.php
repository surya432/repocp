...
<head>
  ...
  <title>{{WebsiteController::getMeta('siteName',$Setting)}} - {{WebsiteController::getMeta('Keyword1',$Setting)}}  </title>
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        ...
        <div class="intro-heading text-uppercase">{{WebsiteController::getMeta('siteDescription1',$Setting)}} </div>
        <div class="intro-lead-in">{{WebsiteController::getMeta('siteDescription2',$Setting)}}</div>
        <a class="btn btn-yellow js-scroll-trigger" href="https://api.whatsapp.com/send?phone={{WebsiteController::getMeta('phoneWA',$Setting)}}&text=%20Hallo%20ingin%20menggunakan%20jasa%20anda%20untuk%20membuat">Hubungi Kami</a>
      </div>
    </div>
  </header>
          ...
          <ul class="timeline">
            <li class="timeline-inverted">
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-body">
                  <p class="text-muted">Pada tahun 2006 kami memulai usaha ini melalui Home Industri di daerah Jawa Tengah. Tepatnya di Kelurahan Tambakrejo Jawa Tengah. Selama kurang lebih 2 Tahun, kami akhirnya memutuskan pindah ke Jombang untuk Pengembangan Usaha.</p>
                </div>
              </div>
            </li>
            <li>
            ...
            <li class="timeline-inverted">
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-body">
                  <p class="text-muted">Selama 9 tahun menjadi CV, pada tahun 2017 regulasi pemerintah mengharuskan semua yang melakukan pemanfaatan dan pengolahan limbah harus berupa PT. Proses untuk menjadi PT. pun tidak mudah karena harus memenuhi beberapa ijin. Kami berjuang dan berusaha untuk mendapatkan semua ijin yang harus didapat. Dari Ijin Lokasi di Desa, Provinsi, ijin dari Kementerian Lingkungan Hidup dan Kehutanan Republik Indonesia (KLHK) untuk pendirian usaha ini.</p>
                </div>
              </div>
            </li>
            <li>
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-body">
                  <p class="text-muted">Semua hal besar berasal dari hal kecil. Terjatuh bukan sebuah kegagalan, asal terus berjuang dan tidak menyerah. Percayalah akan indah pada waktunya.</p>
                </div>
              </div>
            </li>
            <li class="timeline-inverted add-li">
              <div class="btn-blue fit-con">
                <a href="https://api.whatsapp.com/send?phone=6285748990057&text=%20Hallo%20ingin%20menggunakan%20jasa%20anda%20untuk%20membuat">
  ...
  <section class="page-section" id="portfolio">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 portfolio-item cursor" onclick="openModal();currentSlide(2)">
          <div class="box-portfolio">
            <a class="portfolio-link">
              <div class="portfolio-hover">
                <div class="portfolio-hover-content">
        ...
        <div class="modal-contentdokumentasi">
          <div class="row wrap-small-img">
            <div class="column img-demo">
              <img class="demo cursor" src="img/kegiatan/Pelaksanaan-uji-emisi.jpg" onclick="currentSlide(1)" alt="Nama Project 3">
            </div>
            <div class="column img-demo">
              <img class="demo cursor" src="img/kegiatan/Transportasi.jpg" onclick="currentSlide(2)" alt="Nama Project 2">
            </div>
            <div class="column img-demo">
              <img class="demo cursor" src="img/kegiatan/Uji-emisi-cerobong.jpg" onclick="currentSlide(3)" alt="Nama Project 1">
            </div>
            <div class="column img-demo">
              <img class="demo cursor" src="img/kegiatan/Pelaksanaan-uji-emisi.jpg" onclick="currentSlide(4)" alt="Nama Project 3">
            </div>
            <div class="column img-demo">
              <img class="demo cursor" src="img/kegiatan/Transportasi.jpg" onclick="currentSlide(5)" alt="Nama Project 2">
            </div>
            <div class="column img-demo">
              <img class="demo cursor" src="img/kegiatan/Uji-emisi-cerobong.jpg" onclick="currentSlide(6)" alt="Nama Project 1">
            </div>
            <div class="column img-demo">
              <img class="demo cursor" src="img/kegiatan/Pelaksanaan-uji-emisi.jpg" onclick="currentSlide(7)" alt="Nama Project 3">
            </div>
            <div class="column img-demo">
              <img class="demo cursor" src="img/kegiatan/Transportasi.jpg" onclick="currentSlide(8)" alt="Nama Project 2">
            </div>
            <div class="column img-demo">
              <img class="demo cursor" src="img/kegiatan/Uji-emisi-cerobong.jpg" onclick="currentSlide(9)" alt="Nama Project 1">
            </div>
            <div class="column img-demo">
              <img class="demo cursor" src="img/kegiatan/Pelaksanaan-uji-emisi.jpg" onclick="currentSlide(10)" alt="Nama Project 3">
            </div>
          </div>
          <div class="mySlides">
          ...
          <div class="caption-container">
            <h3 id="caption"></h3>
            <p class="font-produk-deskripsi">Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est
  ...
  <footer class="footer">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-4">
          <span class="copyright">Copyright &copy; {!! WebsiteController::getMeta('siteName',$Setting) !!} <?php echo date("Y") ?></span>
        </div>
        <div class="col-md-4">
        </div>
        <div class="col-md-4">
            ...
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                ...
                <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est
                  blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia
                  expedita beatae cupiditate, maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                <a class="btn btn-blue js-scroll-trigger" href="https://api.whatsapp.com/send?phone=6285748990057&text=%20Hallo%20ingin%20menggunakan%20jasa%20anda%20untuk%20membuat">Tertarik</a>
